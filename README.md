...
An advanced chatbot for preliminary medical diagnosis using open source **Qwen LLM**, **LangChain**, and **PineconeDB**. It supports:
...
- 🔍 Retrieval-Augmented Generation (RAG) powered by **open-source Qwen LLM**
...
| **RAG Engine** | LangChain, Pinecone, Qwen LLM (via Hugging Face) |
...
3. 🧾 **LLM-Based Answering**
   - Qwen LLM uses retrieved documents and user input to generate medically coherent answers.
